...
public class grabarpdfFactura {
    ...
    public grabarpdfFactura(List<productos> lst, String nombreE, String rucEmpre, String direcEmpr, float precio, String nro_factura) {
        pdf = new createPdf();
        lstProd = lst;
        txtEmpresa = nombreE;
        txtruc = rucEmpre;
    ...
    public void grabarPdf() {
        ...
        String path1 = "facturas\\" + no_factura + ".pdf";
        String path = "\\facturas\\" + no_factura + ".pdf";
