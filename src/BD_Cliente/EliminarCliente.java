...
String idcliente;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 340, 130, 40));
        ...
        jPanel1.add(jButtonEliminarCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 290, 150, 40));
        ...
        jButton2.setToolTipText("Pulse para regresar al menú.");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 130, 40));
    ...
    private void jTable_clientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_clientesMouseClicked
        ...
        jTextArea1.setText("Nombres: " + jTable_clientes.getValueAt(fila, 1).toString() +
                         "\nApellidos: " + jTable_clientes.getValueAt(fila, 2).toString() +
                         "\nDni: " + jTable_clientes.getValueAt(fila, 3).toString() +
                         "\nDireccion: " + jTable_clientes.getValueAt(fila, 4).toString() +
                         "\nTelefono: " + jTable_clientes.getValueAt(fila, 5).toString() +
                         "\nCorreo: " + jTable_clientes.getValueAt(fila, 6).toString() 
        );
        jTextArea1.setEditable(false);
