...
public class ModificarCliente extends javax.swing.JDialog {
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jTextField_telefono, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)
    ...
    private void jButtonModificarVendedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModificarVendedorActionPerformed
        ...
        if(nombre.length() == 0 || apellido.length() == 0 || dni.length() == 0 || 
           telefono.length() == 0 || correo.length() == 0 || direccion.length() == 0){
            
            JOptionPane.showMessageDialog(rootPane, "Seleccione una fila");
            
        }else{
            change.ModificarCliente(codCliente, nombre,apellido,dni,direccion,telefono,correo);
            llamarClientes();  
        }
...
//SETEAMOS LA FILA SELECCIONADA
        int fila = jTable_clientes.rowAtPoint(evt.getPoint());

        codCliente=(jTable_clientes.getValueAt(fila, 0).toString());
        ...
        jTextField_dni.setText((jTable_clientes.getValueAt(fila, 3).toString()));
        jTextField_direccion.setText((jTable_clientes.getValueAt(fila, 4).toString()));
        jTextField_telefono.setText((jTable_clientes.getValueAt(fila, 5).toString()));
        jTextField_correo.setText((jTable_clientes.getValueAt(fila, 6).toString()));
